...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-9 w-max items-center justify-center rounded-md bg-white px-2 py-2 text-sm  transition-colors  hover:text-stone-900 hover:font-bold focus:text-stone-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:bg-stone-950 dark:hover:text-stone-50 dark:focus:text-stone-50 dark:data-[active]:bg-stone-800/50 dark:data-[state=open]:bg-stone-800/50'
)
